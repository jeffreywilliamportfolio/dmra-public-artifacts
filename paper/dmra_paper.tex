...
secrets, full raw safety-test generations, slur-containing prompt text,
and operationally harmful completions.

Full raw generations are retained in a private controlled archive at
\url{https://github.com/jeffreywilliamportfolio/dmra-controlled-archive}.
The retained archive preserves file-level provenance and checksums for
verification while keeping high-risk generated text separate from the
public release.
