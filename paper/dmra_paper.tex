...
refusal reduction, and visible dialect-to-location inference. The public
artifact bundle maps the descriptive case labels used below to retained
source identifiers.
...
175 words, a 2.19x word-length ratio. Retained source files preserve
full prompt text, output excerpts, and measurements.
...
ratio for the paired comparison output.
...
is safety-oriented and crisis-appropriate.
