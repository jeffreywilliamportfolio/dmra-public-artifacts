...
Together, these strands motivate DMRA. Dialect-bias work shows that
prompt surface can encode socially meaningful information.
Matched-prompt audits provide the comparison design. Safety-evaluation
work shows the limits of refusal-centered scoring. Reasoning-trace work
supplies an additional output surface. DMRA combines these lines to ask
whether matched users receive equivalent safety support across prompt
surfaces.
